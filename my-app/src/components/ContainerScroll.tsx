...
export const ContainerScroll=({titleComponent}:{titleComponent: String | React.ReactNode})=>{
    ...
    const scaleDimensions=()=>{
        return isMobile ? [0.7, 0.9] : [1.05,0.9]; // smaller : larger
    }
    ...
    return (
        <div className='h-[80rem] flex items-center justify-center relative '
          ref={containerRef} 
        >
            <div className='pt-0 pb-[6rem] w-full relative' style={{perspective:"1000px"}}>
